...
!!! note "When Go becomes necessary"
    ...
    — is handled by hooks. Hooks coexist with
...
See the [Reference](../reference/index.md) for full schema documentation.
...
See the [Deploying the Control Center](../controlcenter/deploying.md) for full cluster setup including
...
See the [Katalog Schema](../reference/katalog-schema.md) for the full conversion field reference.
...
See [Declarative Operators: A New Model for Kubernetes Extensibility](../publications/declarative-operators-whitepaper.md)
