...
| Pattern | Covers |
|----------|--------|
| [metadata](02-katalog/00-metadata/index.md) | `metadata` — name, author, version, tags, deprecation |
...
| [when-conditions](02-katalog/06-when-conditions.md) | `when` / `or` conditions |
