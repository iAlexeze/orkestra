...
This declares one PersistentVolumeClaim to be managed by Orkestra.
...
AccessModes — access modes. Default: \["ReadWriteOnce"]. Supports: ReadWriteOnce, ReadOnlyMany, ReadWriteMany, ReadWriteOncePod.
