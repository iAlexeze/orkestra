...
- [Testing leader-led deployments](06-leader-led-deployments.md) — port-forwarding to the elected konductor, not a random follower; `leaderElection` on port-forward entries
