...
//
// This hook provides:
//   - Type-safe struct access to HybridApp spec fields
...
import (
	...
	apiv1 "github.com/orkspace/from-controller-runtime-all-options/options/hybrid/api/v1alpha1"
...
// WebAppHooks returns the hook implementation for the HybridApp CRD.
func WebAppHooks() domain.AnyReconcileHooks {
	return domain.ReconcileHooks[*apiv1.HybridApp]{
...
func onWebAppReconcile(ctx context.Context, obj *apiv1.HybridApp) error {
