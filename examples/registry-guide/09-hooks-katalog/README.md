...
```bash
kubectl get database my-db -n default
kubectl get statefulset my-db -n default
kubectl get cronjob my-db-backup -n default
kubectl get service my-db-svc -n default
```
