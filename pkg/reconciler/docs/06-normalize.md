...
| [pkg/reconciler/normalize.go](../normalize.go) | `applyNormalize` method — the execution engine |
| [pkg/reconciler/generic.go](../generic.go) | Call site: first line of `reconcileImpl` |
