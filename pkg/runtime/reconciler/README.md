...
| `run_template_reconcile.go` | Declarative pipeline: normalize → resolver → onCreate → onReconcile → providers; calls runners in [`pkg/runtime/runners`](../runners/README.md) |
...
Per-resource-type runners (deployments, services, secrets, roles, …) live in [`pkg/runtime/runners`](../runners/README.md).
...
| Understand the runner contract and canonical shape | [pkg/runtime/runners — 01 Runner Contract](../runners/docs/01-runner-contract.md) |
