...
This directory explains how the `pkg/runtime/reconciler` package works and how to add new resource types (e.g. `run_ingress.go`).
...
| [04-conditions.md](04-conditions.md) | `when:` / `or:` evaluation, operators, and the `activeNames` guard |
