...
func buildSecret(name, namespace string, vars []orktypes.DotEnvVar) string {
	var b strings.Builder
	b.WriteString("# ~/.orkestra/doctor/init/apps/<name>/bundle/app-secrets.yaml\n")
...
func buildConfigMap(name, namespace string, vars []orktypes.DotEnvVar) string {
	var b strings.Builder
	b.WriteString("# ~/.orkestra/doctor/init/apps/<name>/bundle/app-config.yaml\n")
	b.WriteString("# Generated by ork doctor deploy — DO NOT COMMIT THIS FILE\n\n")
	b.WriteString("apiVersion: v1\n")
