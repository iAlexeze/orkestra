...
func ExportedCheckIDPPermission(w http.ResponseWriter, r *http.Request, crd *orktypes.CRDEntry, class orktypes.IDPEndpointClass, op, ns string) bool {
	return checkIDPPermission(w, r, crd, class, op, ns)
}
