...
func katalogWithServeAndFieldSelector(target string, selector map[string]string) *Katalog {
	return &Katalog{
...
func katalogWithServeTargetsAndFieldSelectors(targets map[string]map[string]string) *Katalog {
