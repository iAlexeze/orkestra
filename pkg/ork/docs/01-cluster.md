...
The cluster operations in `pkg/ork` cover three concerns: detecting whether Orkestra is installed and healthy, synchronising it after a Katalog change, and managing kind clusters for local development and E2E tests.
