...
**2. Runner — `pkg/registry/e2e/verify.go`**
...
**3. Validator — `pkg/registry/e2e/validate.go`**
...
**6. `onFailure` — `pkg/registry/e2e/onfailure.go`**
...
**7. Fixture — [`pkg/registry/e2e/fixture/e2e.yaml`](./fixture/e2e.yaml)**
