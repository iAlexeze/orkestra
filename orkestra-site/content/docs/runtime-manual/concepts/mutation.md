...
{{< callout type="warning" title="Override overwrites user intent" >}}
...
{{< callout type="note" title="mutateFirst only affects reconcile ordering" >}}
...
{{< callout type="warning" title="RBAC requirement" >}}
```yaml
