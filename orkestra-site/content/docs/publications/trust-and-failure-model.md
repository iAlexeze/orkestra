...
{{< callout type="tip" title="Leader configuration" >}}
...
{{< callout type="important" title="Followers are not idle" >}}
...
{{< callout type="note" title="Admission webhooks during failover" >}}
...
{{< callout type="note" title="safeReconcile is not optional" >}}
...
{{< callout type="warning" title="Choosing FailurePolicy: Fail" >}}
