---
title: "The `useKomposer` field"
weight: 50
description: "Controls which source file is loaded from the pattern. `false` by default."
---
...
!!! warning "Understand the upstream dependency tree"
